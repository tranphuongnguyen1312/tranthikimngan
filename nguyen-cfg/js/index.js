...
function Facebook() {
  setTimeout(function() {
    window.open('https://www.facebook.com/profile.php?id=100061316537575', '_blank')},
  100);
}
function Discord() {
  setTimeout(function() {
...
TurnonHomeThanhDieu();
    ...
    function TurnonHomeThanhDieu() {
        Swal.fire(
			'Trần Thị Kim Ngân <3',
            'Facebook: Trần Thị Kim Ngân',
            'success'
        )
    }

document.write('<div id="Toast">Welcome to TranThiKimNgan website</div>');
